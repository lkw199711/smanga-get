...
router.post('/task/import', [TaskController, 'importTasks'])
...
router.post('/task/repair', [TaskController, 'repair'])
router.post('/task/scan', [TaskController, 'scan'])
router.post('/task/clean', [TaskController, 'clean'])
