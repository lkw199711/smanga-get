...
class ToZip {
  ...
  constructor(mangaFloder: string, outFloder: string, deleteSource: boolean = false) {
  ...
  async start() {
    const mangaName = path.basename(this.mangaFloder)
    const outMangaPath = path.join(this.outFloder, mangaName)
